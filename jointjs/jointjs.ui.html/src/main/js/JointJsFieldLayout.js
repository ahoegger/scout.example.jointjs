scout.JointJsFieldLayout = function(field) {
  scout.JointJsFieldLayout.parent.call(this);
  this.field = field;
};
scout.inherits(scout.JointJsFieldLayout, scout.AbstractLayout);

/**
 * @override AbstractLayout.js
 */
scout.JointJsFieldLayout.prototype.layout = function($container) {
